...
function ajaxRequest(interval_duration, interval_duration_chart_title) {
    $.ajax({
        ...
        success:function(results)
        {
            ...
            updateLiveCharts(datetime, temperature, wind, gust, humidity, pressure, rain, rain_datetime,
...
//----------------Update Charts-----------------------------------------------------------------------------------------
function updateLiveCharts(datetime, temperature, wind, gust, humidity, pressure, rain, rain_datetime, wind_direction, interval_duration)
{
    //Temperature chart
