...
class Config:
    ...
    JSON_WEATHER_ALERT_PATH = os.path.join(basedir, os.environ.get('JSON_WEATHER_ALERT_PATH'))
    JSON_POLLUTION_ALERT_PATH = os.path.join(basedir, os.environ.get('JSON_POLLUTION_ALERT_PATH'))
